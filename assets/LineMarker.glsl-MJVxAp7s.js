import{vN as Z,FS as X,FT as ee,Ev as te,Et as ie,FU as re,FV as ae,EA as o,FL as se,F7 as oe,FK as ne,Ez as w,FW as ce,FX as le,Ew as pe,Ey as de,EB as he,Fu as ve,ED as ue,FY as A,FZ as N,F_ as me,F$ as fe,Fb as ge,g0 as Se,EE as Pe,EF as ye,_ as _e,EG as E,EH as R,EI as we,EJ as U,EK as F,Fd as ze,EM as xe,EN as $e,EO as Te,EQ as V,ER as be,G0 as Ve,G1 as G,G2 as I,G3 as ke,G4 as Oe,G5 as De,ES as We,n as p,ET as d,fZ as Ce,Fe as Ee,G6 as B,qy as Fe,FC as Me,kG as Le,EY as je,cb as q,xt as Ae,gy as Y,cm as H,G7 as Ne}from"./index-8au4tdDY.js";function J(r){const e=new Z,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(X,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
